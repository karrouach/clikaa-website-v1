    ...
    <section className="section-padding">
      <Container>
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <StaggerContainer className="grid grid-cols-2 gap-3 md:gap-4">
            {achievements.map((stat) => (
              <StaggerItem key={stat.label}>
                <motion.div
                  className="rounded-2xl bg-card p-5 md:p-6 text-center"
                ...
                >
                  ...
                  <span className="mt-1 block text-xs md:text-sm text-muted font-medium">
                    {stat.label}
                  </span>
                </motion.div>
              </StaggerItem>
